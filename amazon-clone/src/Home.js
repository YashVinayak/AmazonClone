      ...
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            ...
            price={28249}
            image="https://images-na.ssl-images-amazon.com/images/I/81Chmc5uqVL._SL1500_.jpg"
            rating={4}
          />
          <Product
            id={3}
        ...
        <div className="home__row">
          ...
          <Product
            id={5}
            title="Bose SoundSport Free, True Wireless Earbuds, (Sweatproof Bluetooth Headphones for Workouts and Sports)"
            price={18990}
        ...
        <div className="home__row">
          <Product
            id={6}
            title="Samsung 123 cm (49 Inches) Series 5 Full HD LED Smart TV"
            price={43900}
            image="https://images-na.ssl-images-amazon.com/images/I/91Oun1L4MrL._SL1500_.jpg"
            rating={3}
          />
        </div>
      </div>
